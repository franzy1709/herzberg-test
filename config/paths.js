...
module.exports = {
  ...
  // appIndexJs: resolveModule(resolveApp, 'src/entries/app/index'),
  // techcode
  appPages: [
    {
      name: "index",
      title: "App",
      appHtml: resolveApp("public/app.html"),
      appIndexJs: resolveApp("src/entries/app/index.tsx")
    },
    {
      name: "widget",
    ...
    },
    {
      ...
      appIndexJs: resolveApp("src/entries/web-widget/index.js"),
      isWidgetBundle: true
    }
  ],
